...
input$.pipe(
    ...
    pluck<KeyboardEvent, string>('target','value'), //el tipado hay que cambiarlo y ponerlo como en el ejercicion de AJAX
...
input$.pipe(
    ...
    switchMap( texto => ajax.getJSON(url + texto)  ) //El switchmap cancela la emisión menos la ultima, para reducir las peticiones
